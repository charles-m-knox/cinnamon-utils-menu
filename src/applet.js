//  Inspired by original uuid: restart-cinnamon@kolle,
...
//v0.2:     Added quick & dirty fix for 'gnome-screenshot -a'/'xkill'
//          popup menu problems                                         (3.14.12)
//v0.2.1:   Added "Reload Theme" functionality, updated icon to system-run
//          as, per user billynick's suggestion, as well as generality  (3.14.12)
...
MyApplet.prototype = {
    ...
    _display: function () {
        ...
        //Reload Theme
        let icon = new St.Icon({
            icon_name: "gnome-settings-theme",
            icon_size: ICON_SIZE,
            icon_type: St.IconType.FULLCOLOR
        });
